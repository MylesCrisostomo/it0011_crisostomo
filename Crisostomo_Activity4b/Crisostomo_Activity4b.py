...
currency_input = input("What currency you want to have?").upper()
    
if currency_input in currency:
    converted_amount = USD * currency[currency_input]
    
    print("Dollar\t: " , USD)
    print(currency_input , "\t: ", converted_amount)
    print("\nConversion Summary:")
    print(f"USD: {USD} -> {currency_input}: {converted_amount:.2f}")
else:
